...
{
    public partial class CrearProcListadoArticulos : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE OR ALTER PROCEDURE dbo.ListadoArticulos
        ...
        {
            migrationBuilder.Sql(@"DROP PROCEDURE IF EXISTS dbo.ListadoArticulos");
        }
    }
}
